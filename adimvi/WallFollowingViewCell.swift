...
protocol WallFollowingViewCellDelegate {
    func onTapTag(tag: TagModel)
}

class WallFollowingViewCell: UITableViewCell {
    ...
    var delegate: WallFollowingViewCellDelegate?
...
extension WallFollowingViewCell: TagListViewDelegate {
