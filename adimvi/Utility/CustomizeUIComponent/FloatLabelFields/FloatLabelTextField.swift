...
@IBDesignable class FloatLabelTextField: UITextField {
    ...
    var titleFont:UIFont = UIFont.init(name:"Helvetica Neue", size: 14.0)! {
        didSet {
	...
	@IBInspectable var titleTextColour:UIColor = UIColor.white {
		didSet {
			if !isFirstResponder {
...
//                UIEdgeInsetsInsetRect(r, UIEdgeInsetsMake(top, 0.0, 0.0, 0.0))
	...
	fileprivate func setup() {
		...
		titleActiveTextColour = UIColor.white
		// Set up title label
		title.alpha = 0.0
		title.font = titleFont
		title.textColor = titleTextColour
