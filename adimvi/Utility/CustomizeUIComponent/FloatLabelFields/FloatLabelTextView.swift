...
@IBDesignable class FloatLabelTextView: UITextView {
    ...
    var titleFont:UIFont = UIFont.init(name:"TITILLIUMWEB-SEMIBOLD", size: 17.0)! {
		didSet {
	...
	fileprivate func setup() {
		...
		// Placeholder label
		hintLabel.font = UIFont.init(name:"TITILLIUMWEB-SEMIBOLD", size: 18.0)
		hintLabel.text = hint
	...
	fileprivate func textRect()->CGRect {
		...
		var r =  frame.inset(by: UIEdgeInsets(top: 0, left:0, bottom: 0, right: 0))
